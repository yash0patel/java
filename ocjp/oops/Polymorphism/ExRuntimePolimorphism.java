...
import VehicleRuntimePolimorphism.HmvVehicle;
import VehicleRuntimePolimorphism.LmvVehicle;
import VehicleRuntimePolimorphism.TwVehicle;
import VehicleRuntimePolimorphism.Vehicle;

public class ExRuntimePolimorphism {
	public static void main(String args[]) {
		...
		switch (choice) {
		case 1:
			// Upcasting / Late Binding / Dynamic Binding / Runtime Polimorphism
